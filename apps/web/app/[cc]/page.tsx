...
const LOANS_TOOLS: Tool[] = [
  ...
  { slug: 'credit-card-payoff', label: 'Credit Card Payoff', description: 'Time to pay off your balance, total interest, and savings from extra payments.', comingSoon: true },
  { slug: 'debt-strategy', label: 'Debt Strategy', description: 'Compare snowball, avalanche, and minimum-payment strategies side by side.', comingSoon: true },
];
